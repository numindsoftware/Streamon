...
public class ProjectionTests(ProjectionFixture fixture) : IClassFixture<ProjectionFixture>
{
    ...
    {
        var store = await fixture.StreamStoreProvisioner.CreateStoreAsync(ProjectionFixture.StreamTableName, cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        var entity = await fixture.ProjectionStore.ReadAsync(new OrderProjectionEntity { OrderId = "2" }, cancellationToken: TestContext.Current.CancellationToken);
        Assert.NotNull(entity);
        Assert.NotNull(entity.Items);
        Assert.Single(entity.Items);
    ...
    {
        var entity1 = await fixture.ProjectionStore.ReadAsync(new OrderProjectionEntity { OrderId = "1" }, cancellationToken: TestContext.Current.CancellationToken);
        var entity2 = await fixture.ProjectionStore.ReadAsync(new OrderProjectionEntity { OrderId = "2" }, cancellationToken: TestContext.Current.CancellationToken);
